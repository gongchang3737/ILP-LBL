...
for prop_prob in prop_prob_list:
    ...
    method_list = ['ILP'] # 选择溯源算法['mini_set', 'label_prop', 'ILP']
    ...
    with open('results/MLSL_single_ILP_PP_L'+str(L_num)+'.json', 'w') as f:
...
with open('results/MLSL_single_ILP_PP_L'+str(L_num)+'.json', 'r') as f:
    results = json.load(f)